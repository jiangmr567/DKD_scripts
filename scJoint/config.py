...
class Config(object):
    def __init__(self):
        ...
        # DB info
        self.number_of_class = 13 #celltype numbers.
        self.rna_paths = ['./data/kidney_exprs_rna.npz']
        self.rna_labels = ['./data/kidney_celltype_rna.txt']             
        self.atac_paths = ['./data/kidney_exprs_atac.npz']
